...
{
    [Activity(Label = "SOSI")]
    public class SektorSecBaseActivity : Android.Support.V7.App.AppCompatActivity
    {
        Button DevamEt;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.SektorSecBaseActivity);
        ...
        {
            this.StartActivity(typeof(HizmetSecBaseActivity));
